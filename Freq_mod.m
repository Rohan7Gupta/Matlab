...
t=0:0.00001:0.09999;
f=0:10:99990;
carrier=vc*cos(2*pi*fc*t); % generation of Carrier Signal
message=vm*cos(2*pi*fm*t); % generation of Message Signal
FM=vc*cos((2*pi*fc*t)+10*sin(2*pi*fm*t)); % FM wave
dem=(1/2*pi*10)*diff(10*sin(2*pi*fm*t))/0.2;%% Demod. using PLL
vf=(fft(FM,10^4))/500;
figure(1);
